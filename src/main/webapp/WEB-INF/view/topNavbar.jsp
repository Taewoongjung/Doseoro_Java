...
<%--                            <ul id="list-{{notice.id}}" class="mb-2">--%>
...
<%--                                        <div class="d-flex">--%>
<%--                                            <button id="cancel" class="delBtn" type="submit" onclick="commu_noty_delete('{{notice.id}}')">x</button>--%>
<%--                                            <button type="submit" class="notionMsg" onclick="commu_noty_click('{{notice.id}}')">--%>
...
<%--                                        <div class="d-flex">--%>
<%--                                            <button id="cancel" class="delBtn" type="submit" onclick="commu_noty_delete('{{notice.id}}')">x</button>--%>
<%--                                            <button type="submit" class="notionMsg" onclick="commu_noty2_click('{{notice.id}}')">--%>
...
<%--                                    <input type="hidden" name="theURL" value="{{notice.thisURL}}">--%>
<%--                                    <div class="d-flex">--%>
<%--                                        <button id="cancel" class="delBtn" type="submit" onclick="noty_delete('{{notice.id}}')">x</button>--%>
<%--                                        <button type="submit" class="notionMsg" onclick="noty_click('{{notice.id}}')">--%>
...
<%--                                    <input type="hidden" name="theURL" value="{{notice.thisURL}}">--%>
<%--                                    <div class="d-flex">--%>
<%--                                        <button id="cancel" class="delBtn" type="submit" onclick="noty2_delete('{{notice.id}}')">x</button>--%>
...
<%--                            <ul id="listLike-{{likenotice.id}}" class="mb-2">--%>
...
<%--                                    <!-- <button class="nav-link" type="submit" onclick="like_noty_click('{{likenotice.id}}')">--%>
<%--                                            <button id="cancel" class="delBtn"type="submit"onclick="like_noty_delete('{{likenotice.id}}'">x</button>--%>
<%--                                            <a>[좋아요] {{likenotice.likedNick}} 님이 회원님의 게시물을 찜 했습니다.</a>--%>
<%--                                    </button> -->--%>
<%--                                    <div class="d-flex">--%>
<%--                                        <button id="cancel" class="delBtn" type="submit"--%>
<%--                                            onclick="like_noty_delete('{{likenotice.id}}')">x</button>--%>
<%--                                        <button type="submit" class="notionMsg" onclick="like_noty_click('{{likenotice.id}}')">--%>
...
<%--                                    <button id="cancel" class="delBtn p-2" type="submit" onclick="delAll()">모두삭제</button>--%>
<%--                                </ul>--%>
<%--                            </form>--%>
<%--                        </div>--%>
<%--                        {% endif %}--%>
...
<%--                </li>--%>
                    ...
                    <% } else { %>
                        ...
                        <li class="nav-item"><a class="nav-link p-3" href="/likedProductPage">관심상품</a></li>
    ...
    <script>
        function commu_noty_delete(id) {
            ...
            const notionId = document.getElementById(`list-${id}`); 0
