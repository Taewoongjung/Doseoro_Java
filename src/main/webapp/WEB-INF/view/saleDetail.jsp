    ...
    <main class="saleDetail border container-sm overflow-hidden mt-0 mb-0 min-vh-100 pt-3 pb-5">
        ...
        <div class="w-75 ms-auto me-auto">
            ...
            <div class="wrapBookInfo d-lg-flex align-items-center ">
                <!-- 이미지 슬라이드 -->
                <div id="carouselExampleControls" class="carousel slide slideBox"
                     data-bs-ride="carousel">
                    <div class="carousel-inner">
                        <c:set var="book" value="${book}"/>
                        <c:if test="${book.images[0] ne null}">
                            <div class="carousel-item active">
                                <img class="" src="uploads/imgs${book.images[0]}"
                                     style="border-radius:21px;" width="320px"
                                     height="400px" alt="bookImg">
                            </div>
                        </c:if>
                        <c:if test="${book.images[1] ne null}">
                            <div class="carousel-item">
                                <img class="" src="uploads/imgs${book.images[1]}"
                                     style="border-radius:21px" width="320px"
                                     height="400px" alt="bookImg">
                            </div>
                        </c:if>
                        <c:if test="${book.images[2] ne null}">
                            <div class="carousel-item">
                                <img class="" src="uploads/imgs${book.images[2]}"
                                     style="border-radius:21px" width="320px"
                                     height="400px" alt="bookImg">
                            </div>
                        </c:if>
                        <c:if test="${book.images[3] ne null}">
                            <div class="carousel-item">
                                <img class="" src="uploads/imgs${book.images[3]}"
                                     style="border-radius:21px" width="320px"
                                     height="400px" alt="bookImg">
                            </div>
                        </c:if>
                        <c:if test="${book.images[4] ne null}">
                            <div class="carousel-item">
                                <img class="" src="uploads/imgs${book.images[4]}"
                                     style="border-radius:21px" width="320px"
                                     height="400px" alt="bookImg">
                            </div>
                        </c:if>
                ...
                <div class="bookInfo w-75 me-0 ms-sm-5 align-content-between">
                                ...
                                <form id="book_like-form">
                                    <div class="saleCheck border-0 p-2 d-flex"
                                        ...
                                        <c:if test="${isLiked==null}">
                                            <button class="btn  btn-outline-primary" class="btn"
                                                    type="submit"
                                                    onclick="like()" style="border: 0px">💛️
                                            </button>
                                        </c:if>
                                        <c:if test="${isLiked}">
                                            <button class="btn  btn-outline-primary" class="btn"
                                        ...
                                        <!-- 좋아요 눌린 갯수 -->
                                        <div class="saleCheck border-0 pt-1"
                                             style="border-radius: 10px">
                        ...
                        <div>
                            <form id="sell_item-ED-form-{{book.id}}">
                                ...
                                <input type="hidden" id="delete_it-{{book.id}}"
                                       name="this_item_OwnerId"
                                       value="{{book.OwnerId}}">
                                <input type="hidden" id="delete_it-{{book.id}}"
                                       name="this_item_createdAt"
                                       value="{{book.createdAt}}">
                                <div class="dropdown">
                                    <a class="btn kebobMenu" href="#" data-bs-toggle="dropdown"
                                       aria-expanded="true"><img src="images/kebob.png"
                                                                 alt="dropdownMenu"
                                                                 width="15px"></a>
                                    <ul class="dropdown-menu" aria-labelledby="dropdown1">
                                        ...
                                        <li>
                                            <button id="item-edit-btn-{{book.id}}"
                                                    class="dropdown-item"
                                                    role="menuitem" tabindex="-1" type="submit"
                                                    class="btn"
                                                    onclick="sell_item_edit2('{{book.id}}')">수정
                                            </button>
                                        </li>
                                        {% else %}
                                        <li>
                                            <button id="item-edit-btn-{{book.id}}"
                                                    ...
                                                    role="menuitem" tabindex="-1" type="submit"
                                                    class="btn"
                                                    onclick="sell_item_edit('{{book.id}}')">수정
                                            </button>
                                        </li>
                                        {% endif %}
                                        <li>
                                            <button id="item-delete-btn-{{book.id}}"
                                                    ...
                                                    role="menuitem" tabindex="-1" type="submit"
                                                    class="btn"
                                                    onclick="sell_item_delete('{{book.id}}')">삭제
                                            </button>
                                        </li>
                                    </ul>
                                </div>
                    ...
                    <div class="category d-flex align-items-center mt-2 mb-2">
                        ...
                        <a class="text-body text-decoration-none"
                           id="getAppearanceInfoA">${book.state[0]}</a>
                    </div>
                    <div class="category d-flex align-items-center mt-2 mb-2">
                        <h4 class="h4 fw-bold w-50">거래방법</h4>
                        <a class="text-body text-decoration-none"
                           id="getAppearanceInfoB">${book.tradeMethod}</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="mt-3 border-top w-75 ms-auto me-auto mb-5 pt-4">
            ...
            <div class="mt-3"><a id="getPostingContents"
                                 style="white-space: pre-line;">${book.about}</a></div>
        </div>
        ...
        <form id="comment-form" class="mt-5 w-75 ms-auto me-auto">
            <div class="input-group">
                ...
                <button id="comment-btn" type="submit" class="btn btn-primary"
                        onclick="postComment()"
                        value="Click">댓글달기
                </button>
            </div>
        ...
        <div id="comments-collection" class="w-75 ms-auto me-auto">
            ...
            <table>
                    ...
                    <div>
                        ...
                        <div class="commentList">
                            <div class="d-sm-flex commentListInner">
                                ...
                                <input hidden id="comment-nick-{{comment.id}}"
                                       value="{{comment.commentingNick}}">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdown1">
                                            <li><a id="comment-edit-btn-{{comment.id}}"
                                                   class="dropdown-item"
                                                   role="menuitem" tabindex="-1" type="submit"
                                                   class="btn"
                                                   onclick="re_comment('{{comment.id}}')">댓글</a>
                                            </li>
                                            <li>
                                                <button id="comment-edit-btn-{{comment.id}}"
                                                        class="dropdown-item"
                                                        role="menuitem" tabindex="-1" type="submit"
                                                        class="btn"
                                                        onclick="comment_edit('{{comment.id}}')">수정
                                                </button>
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                <button id="comment-delete-btn-{{comment.id}}"
                                                        ...
                                                        role="menuitem" tabindex="-1" type="submit"
                                                        class="btn"
                                                        onclick="comment_trade_complete('{{comment.id}}')">
                                                    거래완료
                                                </button>
                                            </li>
                                            {% endif %}
                ...
                <form id="re_comment-ED-form-{{comment.id}}-{{re_comment.id}}">
                    ...
                    <input type="hidden" name="recomment_reCommentedId"
                           value="{{re_comment.reCommentedId}}">
                    ...
                    <input type="hidden" name="re_comment_createdAt"
                           value="{{re_comment.createdAt}}">

                    <div class="reCommentList">
                        <div class="reCommentListInner d-sm-flex">
                            <div class="d-flex align-items-center">
                                <div class="p-2"><img src="images/reply.png" style="opacity: 0.5;"
                                                      width="15px"></div>
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdown1">
                                        <li>
                                            <button id="re_comment-edit-btn-{{re_comment.id}}"
                                                    class="dropdown-item"
                                                    role="menuitem" tabindex="-1" type="submit"
                                                    class="btn"
                                        ...
                                        <li>
                                            <button id="re_comment-delete-btn-{{re_comment.id}}"
                        ...
                        <input type="hidden" id="reCom_id-{{re_comment.id}}"
                               name="reCom_edited_comment"
        ...
        <div class="reCommentList">
            <div class="reCommentListInner d-sm-flex">
                <div class="d-flex align-items-center">
                    <div class="p-2"><img src="images/reply.png" style="opacity: 0.5;" width="15px">
                    </div>
                    <div class="comment-nick fw-bold">{{re_comment.reCommentNick}}</div>
                </div>
                <div class="comment-content">{{re_comment.createdAt}}</div>
