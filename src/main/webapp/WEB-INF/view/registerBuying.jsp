    ...
    <main class="registerForm border container-sm overflow-hidden mt-0 mb-0 min-vh-100 pt-3 pb-5">
        <form id="register_book-form" class="regiRequest p-5">
            ...
            <div class="input-group">
                ...
                <input type="text" class="inputForm form-control p-3" id="book-publisher"
                       name="publisher"
                       placeholder="출판사">
            </div>
            ...
            <div>
                <a class="fw-bold h5 text-black-50 text-decoration-none" id="postMyLocation">내
                    위치</a>
            ...
            <button class="btn btn-lg btn-primary w-100" class="btn" type="submit" onclick="one()">
                상품 등록
            </button>
        </form>
    </main>
...
<script>
  function one() {
    ...
    request.setAttribute('action', '/book/buy');
