...
<form id="search-form" action="/searchLoggedIn/it" class="searchForm container pt-2">
    <div class="d-flex align-it">
            ...
            <button id="submitBtn" class="btn btn-primary" type="submit" disabled="true"><img src="images/pngegg.png" width="35" height="25"class="mt-1"></button>

            <!-- 클릭하면 지역 필터 표시/숨김 -->
            <div class="mt-2 ms-2"><a href="#" onclick="showRange('areaFilter')"><img src="images/filter.png" alt="필터이미지" width="30"></a></div>
    </div>
