                            ...
                            <form id="buy_item-ED-form-{{book.id}}">
                                ...
                                <div class="dropdown">
                                    <a class="btn kebobMenu" href="#" data-bs-toggle="dropdown"
                                       aria-expanded="true"><img src="/img/kebob.png"
                                                                 alt="dropdownMenu"
                                                                 width="15px"></a>
                                    <ul class="dropdown-menu" aria-labelledby="dropdown1">
                                        <li>
                                            <button id="item-edit-btn-{{book.id}}"
                                                    ...
                                                    class="btn"
                                                    onclick="buy_item_edit('{{book.id}}')">수정
                                            </button>
                                        </li>
                                        <li>
                                            <button id="item-delete-btn-{{book.id}}"
                                                    ...
                                                    role="menuitem" tabindex="-1" type="submit"
                                                    class="btn"
                                                    onclick="buy_item_delete('{{book.id}}')">삭제
                                            </button>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdown1">
                                            ...
                                            <li>
                                                <button id="item-delete-btn-{{comment.id}}"
                                                        class="dropdown-item"
                                                        role="menuitem" tabindex="-1" type="submit"
                                                        class="btn"
                ...
                <form id="re_comment-ED-form-{{comment.id}}-{{re_comment.id}}">
                    ...
                    <div class="reCommentList">
                        <div class="reCommentListInner d-sm-flex">
                            <div class="d-flex align-items-center">
                                <div class="p-2"><img src="/img/reply.png" style="opacity: 0.5;"
                                                      width="15px"></div>
