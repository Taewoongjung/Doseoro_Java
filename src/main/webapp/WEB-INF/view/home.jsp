                ...
                <div class="carousel-inner">
                    <div class="carousel-item">
                        <div class="justify-content-center text-center pt-4"
                             style="min-height: 500px; max-height: 500px;" focusable="false">
                    ...
                    <div class="carousel-item active">
                        <div class="slide2Inner carousel-inner" focusable="false"
                    ...
                    <a class="carousel-control-prev" href="#bannerList" role="button"
                       data-bs-slide="prev">
                        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                        <span class="visually-hidden">Previous</span>
                    </a>
                    <a class="carousel-control-next" href="#bannerList" role="button"
                       data-bs-slide="next">
            ...
            <div class="d-flex flex-wrap justify-content-center">
                <c:forEach var="book" items="${saleBooks}">
                    <div class="saleCard card mt-4 m-2" style="max-width: 210px;"
                        ...
                        <div class="saleCard card mt-4 m-2" style="max-width: 210px;">
                            <img src="uploads/imgs${book.images[0]}" class="card-img-top"
