...
<body>
    <div class="flex w-100">
        ...
        <main class="form-signin container-sm mt-5 vh-100">
            <form id="login-form">
                ...
                <a class="kakaoLogin" id="kakao" href="/auth/kakao"><img src="images/kakaoLogin.png" class="w-100 mb-2 p-0"></a>
                <a class="googleLogin" id="google" href="/auth/google"><img src="images/googleLogin.png" height="67" class="w-100"></a>
            </form>
        </main>
    ...
    <script src="js/login-cli.js"></script>
