...
class RegisterBookCommandHandlerTest {
    ...
    public void setBookTable() {
        String BOOK_QUERY = "create table if not exists t_book\n" +
                "(\n" +
                ...
                ");";
        jdbcTemplate.execute(BOOK_QUERY);

        String IDENTITY_QUERY = "create table if not exists t_identity\n" +
                "(\n" +
                "seq bigint generated by default as identity,\n" +
                "id varchar(64) not null,\n" +
                ...
                ");";
        jdbcTemplate.execute(IDENTITY_QUERY);
    }
